...
export const metadata = genMetadata({
  ...
  description:
    'Get a free Maravilla home valuation with local pricing context. Dr. Jan Duffy, REALTOR®, uses recent sales, active listings, and current demand. Call (702) 500-1953.',
  keywords:
